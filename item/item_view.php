                        ...
                        <div class="iq-card-body">
                            <div id="table" class="table-editable">
                                <span class="table-add float-right mb-3 mr-2">
                                    <a class="btn btn-primary rounded-pill" href="item_create.php"> create </a>
                                </span>
    ...
    foreach ($results as $result) {
        ?>
                                        <tr>
                                            ...
                                            <td class="text-dark"><?php echo $result->item_code; ?></td>
                                            <td class="text-dark"><?php echo $result->item_name; ?></td>
                                            <td class="text-dark"><?php echo $result->item_category; ?></td>
                                            <td class="text-dark"><?php echo $result->item_subcategory; ?></td>
